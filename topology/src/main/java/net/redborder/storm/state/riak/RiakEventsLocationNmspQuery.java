 ...
 * @author andresgomez
 */
public class RiakEventsLocationNmspQuery extends BaseQueryFunction<MapState<Map<String, Object>>, Map<String, Object>> {

    String _key;
    String _generalkey;
    private boolean _debug;

    public RiakEventsLocationNmspQuery() {

    }

    public RiakEventsLocationNmspQuery(String key) {
        _key = key;
        _generalkey = "";
    }

    public RiakEventsLocationNmspQuery(String key, String generalKey) {
        ...
        List<Map<String, Object>> result = new ArrayList<>();
            ...
            if (!keysToRequest.isEmpty()) {
                ...
                try {
                    ...
                    Logger.getLogger(RiakEventsLocationNmspQuery.class.getName()).log(Level.WARNING, null, e);
                }
            }
