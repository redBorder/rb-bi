 ...
 * @author andresgomez
 */
public class RiakEventsLocationMseQuery extends BaseQueryFunction<MapState<Map<String, Object>>, Map<String, Object>> {

    String _key;
    String _generalkey;
    private boolean _debug;

    public RiakEventsLocationMseQuery() {

    }

    public RiakEventsLocationMseQuery(String key) {
        _key = key;
        _generalkey = "";
    }

    public RiakEventsLocationMseQuery(String key, String generalKey) {
        ...
        List<Map<String, Object>> result = new ArrayList<>();
            ...
            if (!keysToRequest.isEmpty()) {
                ...
                try {
                    ...
                    Logger.getLogger(RiakEventsLocationMseQuery.class.getName()).log(Level.WARNING, null, e);
                }
            }
