 ...
 * @author andresgomez
 */
public class GridGainEventsLocationMseQuery extends BaseQueryFunction<MapState<Map<String, Map<String, Object>>>, Map<String, Object>> {

    String _key;
    String _generalkey;
    private boolean _debug;

    public GridGainEventsLocationMseQuery() {

    }

    public GridGainEventsLocationMseQuery(String key) {
        _key = key;
        _generalkey = "";
    }

    public GridGainEventsLocationMseQuery(String key, String generalKey) {
    ...
    public List<Map<String, Object>> batchRetrieve(MapState<Map<String, Map<String, Object>>> state, List<TridentTuple> tuples) {
        ...
        if (!keysToRequest.isEmpty()) {
            ...
            try {
                ...
                Logger.getLogger(GridGainEventsLocationMseQuery.class.getName()).log(Level.WARNING, null, e);
            }
        }
