 ...
 * @author andresgomez
 */
public class MemcachedEventsLocationMseQuery extends BaseQueryFunction<MapState<Map<String, Object>>, Map<String, Object>> {

    String _key;
    String _generalkey;

    public MemcachedEventsLocationMseQuery(String key) {
        _key = key;
        _generalkey = "rbbi:none:";
    }

    public MemcachedEventsLocationMseQuery(String key, String generalKey) {
        _key = key;
        ...
        if (!keysToRequest.isEmpty()) {
            ...
            try {
               ...
               //  System.out.println("MemcachedResponse: " + memcachedData.toString());
                ...
                Logger.getLogger(MemcachedEventsLocationMseQuery.class.getName()).log(Level.WARNING, null, e);
            }
        }
