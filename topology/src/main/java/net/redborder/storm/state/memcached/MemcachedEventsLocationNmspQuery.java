 ...
 * @author andresgomez
 */
public class MemcachedEventsLocationNmspQuery extends BaseQueryFunction<MapState<Map<String, Object>>, Map<String, Object>> {

    String _key;
    String _generalkey;

    public MemcachedEventsLocationNmspQuery(String key) {
        _key = key;
        _generalkey = "rbbi:none:";
    }

    public MemcachedEventsLocationNmspQuery(String key, String generalKey) {
        _key = key;
        ...
        if (!keysToRequest.isEmpty()) {
            ...
            try {
               ...
               //  System.out.println("MemcachedResponse: " + memcachedData.toString());
                ...
                Logger.getLogger(MemcachedEventsLocationNmspQuery.class.getName()).log(Level.WARNING, null, e);
            }
        }
